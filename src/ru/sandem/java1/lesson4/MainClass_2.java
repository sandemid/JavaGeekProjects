...
public class MainClass_2 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < length; i++) {
            cats[i] = new Cat("ru.sandem.java_1.lesson4_2.Cat" + (i + 1), random.nextInt(5), random.nextDouble() * 3, random.nextInt(300));
            dogs[i] = new Dog("ru.sandem.java_1.lesson4_2.Dog" + (i + 1), random.nextInt(20), random.nextDouble() * 1.5, random.nextInt(700));
        }
